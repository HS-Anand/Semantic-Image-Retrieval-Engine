...
def reset_cloudinary():
    ...
    result = (
        cloudinary.api
        .delete_resources_by_prefix("sire-images/")
    )

    cloudinary.api.delete_folder("sire-images")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("SIRE storage reset complete")
